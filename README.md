...
|A (достижимость)|<i>Команда разработки (M = чем?)>|✅ или ❌|
...
#### 1.2.2 Цель (изменяемый критерий SMART цели системы): Увеличение числа уровней сложностей
...
#### 1.4.3 [пользовательская история (ссылка на issue)](https://github.com/modernClown/Armen.github.io/issues) 
- Кто: Все студенты потока
- Роль: Студент
- Хочу: Получить приложение для игры в судоку
- Чтобы: Научиться принципам НОРД с помощью многоагентного подхода
- Приемка: Судоку с решателем
...
|--|--|--|--|--|
|1|<Программист заболеет>|🟡|Принятие (Acceptance)|Задачи будет выполнять заместитель
|2|<Команда не успеет реализовать проект в срок>| 🟡|Уклонение (Avoidance)<br>Снижение (Mitigation)| Предоставление первичной версии проекта
